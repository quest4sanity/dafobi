...
public class DataTypeTest {
	...
	public void testParam() {
		...
		param = DataType.TIMESTAMP.param(Timestamp.valueOf("2018-06-12 15:20:34"));
		assertEquals(DataType.TIMESTAMP, param.getType());
	...
	public void testConvert() throws ParseException {
		...
		assertEquals(Timestamp.valueOf("2018-06-12 15:20:34"), DataType.TIMESTAMP.convert("2018-06-12 15:20:34"));
	}
