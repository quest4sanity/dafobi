 ...
 * выражений и контейнера общего вида (расположенного в данном пакете). 
 * В вычислимых выражениях всегда используется другой класс, который 
 * имплементирует данный интерфейс и отнаследованый от ELContext.
 * </p>
 * 
 * @author Q4S
 *
