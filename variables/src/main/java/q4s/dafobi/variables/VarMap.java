...
import q4s.dafobi.variables.map.VarMapELResolver;
 ...
 * 
 */
public class VarMap extends TreeMap<String, IVar> implements
		IELResolvable {
	 ...
	 * @param m
	 */
	public VarMap(Map<? extends String, ? extends IVar> m) {
		super(m);
	}
	 ...
	 */
	@Override
	public IVar put(String key, IVar value) {
	 ...
	 */
	@Override
	public void putAll(Map<? extends String, ? extends IVar> m) {
		for (Map.Entry<? extends String, ? extends IVar> e : m
				.entrySet()) {
	...
	public Map<String, Object> getAllValues() {
		...
		for (Map.Entry<String, IVar> item : entrySet()) {
	...
	public Object[][] allDebugValues() {
		...
		int i = 0;
		for (Map.Entry<String, IVar> entry : entrySet()) {
