...
public class ExpressionVarMapTest {
	...
	public void setUp() throws Exception {
		...
		map.put("n1", new Var(new BigDecimal("123.3"), DataType.NUMBER));
		map.put("n2", new Var(new BigDecimal("312.2"), DataType.NUMBER));
		map.put("n3", new Var(new BigDecimal("321.1"), DataType.NUMBER));
	...
	public void testSetType() {
		...
		expr = new Expression(context, "#{m.n1}", DataType.NUMBER);
		assertEquals(DataType.NUMBER, expr.getType());
