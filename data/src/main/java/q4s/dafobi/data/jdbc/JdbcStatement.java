...
import q4s.dafobi.data.AbstractStatement;
...
public class JdbcStatement extends AbstractStatement {
	 ...
	 * (non-Javadoc)
	 * 
	 * @see q4s.dafobi.data.IStatement#getParameters()
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 * 
	 * @see q4s.dafobi.data.IStatement#getOutParameters()
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 * 
	 * @see q4s.dafobi.data.AbstractStatement#setParam(java.lang.String,
	 ...
	 * (non-Javadoc)
	 * 
	 * @see q4s.dafobi.data.AbstractStatement#close()
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 * 
	 * @see q4s.dafobi.data.IStatement#isClosed()
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 * 
	 * @see q4s.dafobi.data.IStatement#query()
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 * 
	 * @see q4s.dafobi.data.IStatement#execute()
	 */
	@Override
	public int execute() {
		try {
	 ...
	 * (non-Javadoc)
	 * 
	 * @see q4s.dafobi.data.IStatement#addBatch()
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 * 
	 * @see q4s.dafobi.data.IStatement#executeBatch()
	 */
	@Override
