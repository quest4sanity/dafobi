...
public abstract class AbstractResultTable implements IResultTable {
	 ...
	 * (non-Javadoc)
	 * 
	 * @see q4s.dafobi.data.IResultTable#count()
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 * 
	 * @see q4s.dafobi.data.IResultTable#getColumnIndex(java.lang.String)
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 * 
	 * @see q4s.dafobi.data.IResultTable#getColumnName(int)
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 * 
	 * @see q4s.dafobi.data.IResultTable#getColumnType(int)
	 */
	@Override
