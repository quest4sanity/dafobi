...
public abstract class AbstractConnection implements IConnection {
	 ...
	 * (non-Javadoc)
	 * 
	 * @see q4s.dafobi.data.ITransaction#execute(java.lang.String,
	 * java.util.Map)
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 * 
	 * @see q4s.dafobi.data.ITransaction#executeScript(java.lang.String,
	 * java.util.Map)
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 * 
	 * @see q4s.dafobi.data.ITransaction#query(java.lang.String,
	 * java.util.Map)
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 * 
	 * @see q4s.dafobi.data.ITransaction#queryRow(java.lang.String,
	 * java.util.Map)
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 * 
	 * @see q4s.dafobi.data.ITransaction#close()
	 */
	@Override
	public void close() {
